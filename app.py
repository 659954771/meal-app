...
TRANS = {
    ...
    "help_title": "📱 如何添加到手机桌面？(像APP一样使用)",
    "help_android": "🤖 安卓 (Android): 点击浏览器右上角三个点 -> 选择【添加到主屏幕】",
    "help_ios": "🍎 苹果 (iOS): 点击浏览器下方【分享】按钮 -> 选择【添加到主屏幕】",
...
# --- B. 主界面 ---
    ...
    with st.expander(TRANS["help_title"]):
        st.write(TRANS["help_android"])
        st.write(TRANS["help_ios"])
        st.caption("✅ 添加后，下次点击桌面图标即可直接进入，无需登录！")
